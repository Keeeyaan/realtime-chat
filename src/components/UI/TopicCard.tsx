...
const TopicCard = ({ topic, rooms }: TopicCardProps) => {
  return (
    <div className='w-[120px] text-center min-w-fit shadow-md transform transition-all ease-in-out duration-150 hover:-translate-y-1'>
      <div className=' h-[70px] rounded-t bg-blue-600' />
